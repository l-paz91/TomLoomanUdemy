...
#define UE_PROJECT_NAME TomLoomanStarter
#define UE_TARGET_NAME TomLoomanStarterEditor
...
#define TOMLOOMANSTARTER_API DLLIMPORT
#define OBJECTIVEACTOR_API DLLEXPORT
